    ...
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <Text style={styles.searchPlaceholder}>Search dishes, restaurants, cuisines...</Text>
        </TouchableOpacity>
        ...
        <View style={styles.sectionHeader}>
          <Text style={styles.sectionTitle}>
            {selectedCategory === 'All' ? 'Open Restaurants' : `"${selectedCategory}" Restaurants`}
          </Text>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyState}>
              <MaterialCommunityIcons name="store-off-outline" size={48} color="#D0D5DD" />
