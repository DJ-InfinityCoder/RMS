      ...
      <View style={styles.permissionContainer}>
        ...
        <View style={styles.permissionCard}>
          ...
          <Text style={styles.permissionDesc}>
            Allow camera access to scan restaurant menus and extract items
            instantly
          </Text>
          <TouchableOpacity
                      ...
                      return (
                        <View key={stage} style={styles.stageItem}>
                          ...
                          <Text
                            style={[
                              styles.stageLabel,
                              (isActive || isDone) && styles.stageLabelActive,
                            ]}
                          >
                            {stage === "ocr"
                              ? "OCR"
            ...
            >
              <View style={styles.sideBtnInner}>
                <Ionicons
                  ...
                  size={24}
                  color={flashMode === 'on' ? COLORS.accent : COLORS.textPrimary}
                />
              </View>
              <Text style={[styles.sideBtnLabel, flashMode === 'on' && { color: COLORS.accent }]}>Flash</Text>
            </TouchableOpacity>
          </View>
        )}
      </View>
